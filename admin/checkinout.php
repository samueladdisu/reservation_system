            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Checkin/Checkout Report</h1>
                        ...
                        <div class="col-12 mb-2">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Chackin/Checkout Report</h6>
                                </div>
                                <div class="card-body">
                                    <!------------------------- t-date picker  --------------------->
                                    <div class="card shadow mb-4">
                ...
                <script>
                    ...
                    const app = Vue.createApp({
                        ...
                        methods: {
                            ...
                            async fetchDataAll() {
                                await axios.post('./includes/backEndreservation.php', {
                                    action: 'fetchAllCheckinoutReport',
                                    location: this.location
                                }).then(res => {
                                    console.log(res.data);
                                    this.table(res.data)
