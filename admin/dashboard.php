    ...
    <div id="content-wrapper" class="d-flex flex-column">
      ...
      <div id="content">
        ...
        <div class="container-fluid">
          ...
          <!-- Page Heading -->
          <div class="row mb-4">
            <h1 class="h3 mb-0 col-8 text-gray-900">Welcome to Admin
            ...
            <select name="" id="" class="custom-select col-2">
                  ...
                  <div class="card-body">
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        ...
                        <div class='h6 mb-0 mt-2 text-gray-600'>12</div>
                        <?php
                    ...
                    <div class="row no-gutters align-items-center">
                      <div class="col mr-2">
                        <div class="text-xs font-weight-bold text-info text-uppercase mb-1">
                          ...
                          <div class='h6 mb-0 mt-2 text-gray-600'>13</div>
                        <?php
