          ...
          <div class="tab-content" id="myTabContent">
            ...
            ?>
              ...
              <?php } else if ($_SESSION['user_location'] == 'Entoto') { ?>
                ...
                <div class="tab-pane show active fade mt-4" id="entoto" role="tabpanel" aria-labelledby="entoto-tab">
                  <div class="d-flex justify-content-center">
              ...
              <?php } else if ($_SESSION['user_location'] == "Awash") { ?>
                ...
                <div class="tab-pane show active fade mt-4" id="awash" role="tabpanel" aria-labelledby="awash-tab">
              ...
              <?php } else if ($_SESSION['user_location'] == "Lake Tana") { ?>
                <div class="tab-pane show active fade mt-4" id="tana" role="tabpanel" aria-labelledby="tana-tab">
                  <div class="d-flex justify-content-center">
