...
<head>
    ...
    <title>Kuriftu Reservation System</title>
                                ...
                                <div class="p-5">
                                    ...
                                    <form class="user" action="./includes/login.php" method="POST">
                                        <div class="form-group">
                                            <input type="text" class="form-control form-control-user" id="exampleInputEmail" name="user_name" aria-describedby="emailHelp" placeholder="Enter User Name..." required>
                                        </div>
                                        <div class="form-group">
