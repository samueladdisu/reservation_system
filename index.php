...
<head>
  ...
  <title>Destination Select</title>
</head>
    ...
    <div class="container">
      ...
      <div class="wrapper">
        ...
        <!-- <div class="single-destination">
          ...
          <div class="desc">
            <div class="desc-wrapper">
              <h4>Kuriftu Resort & Spa Afar</h4>
              <p class="location-txt">Afar, Ethiopia </p>
              ...
              <div class="details">
                ...
                <a href="./selectroom.html"> <button class="btn btn-outline-black btn-detail">Unavaliable Now </button></a>
              </div>
            </div>
